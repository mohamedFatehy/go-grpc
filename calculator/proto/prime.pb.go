...
type PrimeRequest struct {
	...
	PrimeNumber uint32 `protobuf:"varint,1,opt,name=prime_number,json=primeNumber,proto3" json:"prime_number,omitempty"`
}
...
func (x *PrimeRequest) GetPrimeNumber() uint32 {
	if x != nil {
...
type PrimeResponse struct {
	...
	PrimeResult uint32 `protobuf:"varint,1,opt,name=prime_result,json=primeResult,proto3" json:"prime_result,omitempty"`
}
...
func (x *PrimeResponse) GetPrimeResult() uint32 {
	if x != nil {
...
var file_prime_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x70, 0x72, 0x69, 0x6d, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d,
	0x6f, 0x68, 0x61, 0x6d, 0x65, 0x64, 0x46, 0x61, 0x74, 0x65, 0x68, 0x79, 0x2f, 0x67, 0x6f, 0x2d,
