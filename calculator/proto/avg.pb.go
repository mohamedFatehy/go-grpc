...
func (x *AvgRequest) GetNumber() uint32 {
	if x != nil {
		return x.Number
	}
	return 0
...
type AvgResponse struct {
	...
	AvgResult float32 `protobuf:"fixed32,1,opt,name=avg_result,json=avgResult,proto3" json:"avg_result,omitempty"`
}
...
func (x *AvgResponse) GetAvgResult() float32 {
	if x != nil {
		return x.AvgResult
	}
	return 0
...
var file_avg_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x2c, 0x0a,
	0x0b, 0x41, 0x76, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a,
	0x61, 0x76, 0x67, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02,
	0x52, 0x09, 0x61, 0x76, 0x67, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x33, 0x5a, 0x31, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x6f, 0x68, 0x61, 0x6d, 0x65,
	0x64, 0x46, 0x61, 0x74, 0x65, 0x68, 0x79, 0x2f, 0x67, 0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2f,
