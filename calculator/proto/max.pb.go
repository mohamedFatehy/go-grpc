...
type MaxResponse struct {
	...
	MaxResult uint32 `protobuf:"varint,1,opt,name=max_result,json=maxResult,proto3" json:"max_result,omitempty"`
}
...
func (x *MaxResponse) GetMaxResult() uint32 {
	if x != nil {
		return x.MaxResult
	}
	return 0
...
var file_max_proto_rawDesc = []byte{
	...
	0x0b, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a,
	0x6d, 0x61, 0x78, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x09, 0x6d, 0x61, 0x78, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x33, 0x5a, 0x31, 0x67,
